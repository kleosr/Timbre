...
class MicroServiceExecutionService : Service() {
    ...
    private val CHANNEL_ID = "VoiceVibeServiceChannel"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = "VoiceVibe Service Channel"
            val descriptionText = "Channel for VoiceVibe micro-services"
    ...
    companion object {
        // Intent actions
        const val ACTION_CREATE_SERVICE = "com.voicevibe.action.CREATE_SERVICE"
        const val ACTION_START_SERVICE = "com.voicevibe.action.START_SERVICE"
        const val ACTION_STOP_SERVICE = "com.voicevibe.action.STOP_SERVICE"
        
        // Broadcast actions
        const val ACTION_SERVICE_CREATED = "com.voicevibe.SERVICE_CREATED"
        const val ACTION_SERVICE_STARTED = "com.voicevibe.SERVICE_STARTED"
        const val ACTION_SERVICE_STOPPED = "com.voicevibe.SERVICE_STOPPED"
